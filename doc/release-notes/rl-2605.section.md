...
- []{#x86_64-darwin-26.05}
  ...
  **This will be the last release of Nixpkgs to support `x86_64-darwin`.**
  ...
  For 26.11, due to Apple’s deprecation of the platform and limited build infrastructure and developer time, we will no longer build packages for `x86_64-darwin` or guarantee that it can build at all.
